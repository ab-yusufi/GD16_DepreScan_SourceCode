...
def main():
    ...
    main.detector = EmotionRecognizer(estimator_dict[args.model], emotions=args.emotions.split(","), features=features, verbose=0)
    main.detector.train()
    #print("Test accuracy score: {:.3f}%".format(detector.test_score()*100))
    playaudio("hiphip.mp3")
    print("Please talk")
    playaudio("beep.mp3")
    
    filename = "test.wav"
    record_to_file(filename)
    main.result = main.detector.predict(filename)
    print(main.result)
