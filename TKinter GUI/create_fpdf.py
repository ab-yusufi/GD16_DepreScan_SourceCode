...
tableCol1 = ["Depression Score", "Enthusiasm", "Anxiety","PHQ"]
tableCol3 = ["10-100%", "60-90%", "20-80%","18-27"]
phqText = ""
...
def create_pdf(pname,pemail,pphone,page,pgender,dscore,enthu,anx,phq):
    ...
    if(int(phq) >= 15):
        pdf.set_text_color(r=153, g= 0, b = 0)
    else:
        pdf.set_text_color(r=76, g= 153, b = 0)
    pdf.ln(ch)
    pdf.cell(w=50, h=ch, txt=f'According to your PHQ Score, you are in "{phqText}".', ln=1)
    ...
    pdf.cell(w=30, h=ch, txt="2) The test results should be interpreted by a certified medical professional.", ln=1)
    pdf.multi_cell(w=180, h=ch, txt="3) The result is for indicative purpose only. The result published are for immediate information to the patient. ")
...
create_pdf("Yash Kandalkar","yashkandalkar555@gmail.com","9370003979","21","Male","66%","25%","30%","13")